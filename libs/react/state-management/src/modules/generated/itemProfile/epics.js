...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "itemProfile" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "itemProfile" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "itemProfile" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "itemProfile" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "itemProfile" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "itemProfile" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "itemProfile" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "itemProfile" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "itemProfile" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "itemProfile" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "itemProfile" workflow.
 */
